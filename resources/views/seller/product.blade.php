<x-app-layout>
            ...
            <div class="bg-white dark:bg-gr.ay-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form action="{{ route('seller.product') }}" method="GET" class="flex items-center">
                            ...
                            <button type="submit" class="p-2 ml-2 text-sm font-medium text-white bg-primary-700 rounded-lg border border-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <form action="{{ route('product.destroy', $product->id) }}" method="POST" id="delete-product-form">
                                                ...
                                                <button type="submit"
                                                    class="flex items-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900" onclick="return confirm('Are you sure you want to delete it?')">
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Menampilkan {{ $products->firstItem() ? $products->firstItem() : 0 }} - {{ $products->lastItem() ? $products->lastItem() : 0 }} dari {{ $products->total() }} hasil
                    </span>
    ...
    <form action="#" id="drawer-update-product"
        class="fixed top-0 left-0 z-40 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray"
        ...
        <style>
            [drawer-backdrop] {
                background-color: rgba(255, 0, 0, 0.3); /* semi-transparent red, for example */
            }
        </style>
