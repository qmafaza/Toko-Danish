      ...
      <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
              ...
              <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                @forelse ($addresses as $address)
                  <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                    <label for="" class="flex items-start cursor-pointer">
                      <div class="flex h-5 items-center">
                        <input id="" aria-describedby="dhl-text" {{ $address->is_primary ? 'checked' : '' }} type="radio" name="" value="" class="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"/>
                      </div>
                      <div class="ms-4 text-sm">
                        <span class="font-medium leading-none text-gray-900 dark:text-white"> JNE </span>
                        <p id="" class="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">Jalur Nugraha Ekakurir </p>
                      </div>
                    </label>
                  </div>
                @empty
                  <p class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> No address found! </p>
                @endforelse
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                <label for="dhl1" class="flex items-start cursor-pointer">
                  <div class="flex h-5 items-center">
                    <input id="dhl1" aria-describedby="dhl-text" type="radio" name="delivery-method" value="" class="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"/>
                  </div>
                  <div class="ms-4 text-sm">
                    <span class="font-medium leading-none text-gray-900 dark:text-white"> JNE </span>
              ...
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                <label for="dhl2" class="flex items-start cursor-pointer">
                  <div class="flex h-5 items-center">
                    <input id="dhl2" aria-describedby="dhl-text" type="radio" name="delivery-method" value="" class="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"/>
                  </div>
                  <div class="ms-4 text-sm">
              ...
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                <label for="dhl3" class="flex items-start cursor-pointer">
                  <div class="flex h-5 items-center">
                    <input id="dhl3" aria-describedby="dhl-text" type="radio" name="delivery-method" value="" class="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"/>
                  </div>
                  <div class="ms-4 text-sm">
        ...
        <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
          ...
          <div class="space-y-3">
            ...
            <button disabled class="flex w-full items-center justify-center rounded-lg bg-gray-400 px-5 py-2.5 text-sm font-medium text-white cursor-not-allowed">Proceed to Payment</button>
