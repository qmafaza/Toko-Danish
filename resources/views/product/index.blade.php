                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">Rp {{ $product->price }}</p>
                            ...
                            <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="allview"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Allview (45)
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="brother"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Brother (176)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="biostar"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Biostar (49)
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="corsair"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Corsair (15)
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="dogfish"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Dogfish (24)
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="extreme"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Extreme (10)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="elgato"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Elgato (234)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="emerson"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Emerson (45)
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="fujitsu"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Fujitsu (97)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="foxconn"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Foxconn (234)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="floston"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Floston (45)
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="1-1-5-kg"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1-1,5 kg
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="1-5-2-kg"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1,5-2 kg
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="2-5-3-kg"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 2,5-3 kg
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="over-3-kg"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Over 3 kg
                                            </label>
                                        </div>
                                    </div>
                                </div>
