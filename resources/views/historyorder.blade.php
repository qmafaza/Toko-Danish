      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="mt-6 flow-root sm:mt-8">
          <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="flex flex-wrap items-center gap-y-4 py-6 border-b border-gray-200 dark:border-gray-700">
              <!-- Order ID -->
              ...
              <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                ...
                <dd class="me-2 mt-1.5 inline-flex items-center rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                  ...
                  {{ $order->status == 0 ? 'Pre-order' : ($order->status == 1 ? 'Processing' : 'Completed') }}
                </dd>
              </dl>

              <a href="{{ route('summary.order', $order->id) }}" class="w-full inline-flex justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 lg:w-auto">
                View details
              </a>
              <!-- Actions -->
